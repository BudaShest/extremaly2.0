                ...
                <Row>
                    <Col s={9}>
                        <Row style={{backgroundColor: 'rgba(0, 0, 0, 0.5)'}}>
                            <Col className="white-text " s={3} style={{fontSize: '1.3em'}}>Событие:</Col>
                            <Col className="white-text " s={3} style={{fontSize: '1.3em'}}>Цена билета:</Col>
                            <Col className="white-text " s={3} style={{fontSize: '1.3em'}}>Кол-во: </Col>
                            <Col className="white-text " s={3} style={{fontSize: '1.3em'}}>Суммарно: </Col>
                        </Row>
                        {
                    ...
                    <Col className={style.summaryBlock} s={3}>
